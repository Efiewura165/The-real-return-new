...
/** Only appears after the visitor scrolls past the hero, so it never sits on top of a page's own hero CTAs. */
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-40 flex h-12 items-center gap-2 rounded-sm bg-[#25D366] py-2 pl-3 pr-4 text-[0.75rem] font-semibold uppercase tracking-[0.14em] text-white shadow-[0_8px_24px_rgba(0,0,0,0.35)] transition-all duration-300 hover:scale-105 ${
