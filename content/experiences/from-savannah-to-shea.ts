...
export const fromSavannahToShea: ExperiencePackage = {
  ...
  whyThisExperience:
    "Shea is one of the clearest throughlines between ancestral African craft and the diaspora's daily life — in the lotions, soaps, and hair products found in homes across America, Canada, the UK, and beyond. To sit with the women who still make it by hand, exactly as it has been made for generations, is to see that thread made visible.",
